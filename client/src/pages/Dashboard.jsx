      ...
      <div className="bg-white shadow px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative group">
            ...
            />
            <div className="absolute hidden group-hover:block right-0 mt-2 bg-white shadow border rounded-lg z-20">
              <ul className="text-sm text-blue-600 font-semibold cursor-pointer">
                <li className="px-4 py-2 hover:underline">Logout</li>
              </ul>
            </div>
          </div>
        </div>
